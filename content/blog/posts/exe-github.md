...
exe.dev works. I'm purely inferring based on my understanding of the interfaces
involved.
...
- The hostname `int.exe.eyz` doesn't exist and doesn't even have an NS. However,
  ...
  exe.dev VM, because...
- The hostname `my-integration.int.exe.xyz` points to 169.254.169.254, which is
...
Now, your secrets management problem has been reduced to exe.dev maintaining custody
...
[acme-dns]: https://letsencrypt.org/docs/challenge-types/#dns-01-challenge
